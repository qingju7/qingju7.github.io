...
function showWelcome() {
    ...
    let dist = getDistance(114.55907, 25.71687, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里记录你自己的经纬度
    ...
    //自定义文本需要放的位置
    document.getElementById("welcome-info").innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>你距离青橘约有<span>${dist}</span>公里，${posdesc}`;
}
